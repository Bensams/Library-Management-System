...
public class ManageLibrary {
    ...
    @FXML
    private Tab availableBooksTab;
    @FXML
    private Tab borrowedBooksTab;
    @FXML
    ...
    private void initialize() {
        try {
            ...
            tabPane.getSelectionModel().selectedItemProperty().addListener((observable, oldTab, newTab) -> {
                ...
                } else if (newTab == availableBooksTab) {
    ...
    public List<BorrowedBook> getBorrowedBooksForCurrentBorrower(Borrower borrower) {
        Library library = Library.getInstance();
        return library.getBorrowedBooksByUser(borrower);
    }
    ...
    private void deleteBook(Book book) {
        Library.getInstance().removeBookFromLibrary(book.getBookID());
...
private void addAccountAction() {
    ...
    private ObservableList<User> getAccountsList() {
        return FXCollections.observableArrayList(Library.getInstance().getUsers());
    }
    ...
    private void deleteUser(User user) {
        ...
        List<BorrowedBook> borrowedBooks = library.getBorrowedBooksByUser(user);

        for (BorrowedBook borrowedBook : borrowedBooks) {
            library.returnBook(borrowedBook);
        }

        library.trackBorrowedBooks().remove(user);
    ...
    private void updateUser(User user) {
        try {
            ...
            controller.setUser(user, new UserManagement());
    ...
    private void onAddBtnClick() {
        ...
        if (Library.getInstance().bookExists(bookID_TF.getText())) {
